...
/**
 * This class provides test data for the {@link Repository} class. It extends the {@link DomainCrudDataProvider} class
 * and provides methods to create new test data objects, update existing data objects, and generate JSON patches for updates.
 */
@Component
public class RepositoryDataProvider extends DomainCrudDataProvider<Repository, RepositoryDto, RepositoryCriteria, RepositoryRepository, RepositoryService> {
     ...
     * Creates a new DTO object with mandatory fields set.
     */
    public static RepositoryDto prepareMandatoryDto() {
    ...
    public JsonPatch getJsonPatch() {
        ...
        operations.add(new ReplaceOperation(new JsonPointer(String.format("/%s", Repository.FN.description)), new TextNode(UPDATED_STRING)));
     ...
     */
    @Override
    public RepositoryDto getNewDto() {
        return newDto;
    }
     ...
     */
    @Override
    public void updateDto(RepositoryDto dto) {
     ...
     */
    @Override
    public RepositoryDto getMandatoryNewDto() {
     ...
     */
    @Override
    public void updateMandatoryDto(RepositoryDto dto) {
    ...
    public List<JsonPatchOperation> getMandatoryJsonPatchOperation() throws JsonPointerException {
        ...
        operations.add(new ReplaceOperation(new JsonPointer(String.format("/%s", Repository.FN.name)), new TextNode(UPDATED_STRING)));
        return operations;
    }

    @Override
    public void assertMandatoryGet(RepositoryDto before, RepositoryDto after) {
        super.assertMandatoryGet(before, after);
        Assertions.assertThat(after.getName()).isEqualTo(before.getName());
    }

    @Override
    public void assertGet(RepositoryDto before, RepositoryDto after) {
    ...
    @Override
    public void assertMandatoryUpdate(RepositoryDto dto, RepositoryDto updatedDto) {
    ...
    @Override
    public void assertUpdate(RepositoryDto dto, RepositoryDto updatedDto) {
        super.assertUpdate(dto, updatedDto);
        assertMandatoryUpdate(dto, updatedDto);
    }

    @Override
    public void assertMandatorySave(RepositoryDto dto, RepositoryDto savedDto) {
        super.assertMandatorySave(dto, savedDto);
        assertMandatoryGet(dto, savedDto);
    }

    @Override
    public void assertSave(RepositoryDto dto, RepositoryDto savedDto) {
