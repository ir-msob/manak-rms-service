...
@Testcontainers
@CommonsLog
public class RepositorySpecificationCharacteristicRestResourceIT
        extends BaseCharacteristicCrudRestResourceTest<RepositorySpecification, RepositorySpecificationDto, RepositorySpecificationCriteria, RepositorySpecificationRepository, RepositorySpecificationService, RepositorySpecificationDataProvider, RepositorySpecificationService, RepositorySpecificationCharacteristicCrudDataProvider>
    ...
    public void beforeEach() {
        ...
        RepositorySpecificationCharacteristicCrudDataProvider.createNewChild();
    }
    ...
    public Class<? extends BaseResource<String, User>> getResourceClass() {
        return RepositorySpecificationCharacteristicRestResource.class;
    }
}
